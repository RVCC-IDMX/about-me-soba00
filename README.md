...
### Planned Features
 ...
 - JavaScript for form validation and interactivity independent from netlify
 - fully integrated keyboard only navigation
 - full moible page version

### Multi-Page Expantion

 - New portfolio pages including expanded "Gallery" and Blog pages
 - New "Projects" page
 - improved multi-page navigation system
